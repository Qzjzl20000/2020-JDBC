...
public class FrmCMDmodifySP extends JFrame {
	 ...
	 * Create the frame.
	 */
	public FrmCMDmodifySP() {
		
	}
	public FrmCMDmodifySP(BeanSp sp) {
		...
		JLabel lblNewLabel = new JLabel("您正在修改分栏："+sp.getSp_name());
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==btnNewButton) {
					...
					String price=new String(textField.getText());
					String left=new String(textField_3.getText());
					try {
						WaiMaiUtil.CMDManager.modifySP(sp, name, price, left);
						setVisible(false);
		...
		JLabel lblNewLabel_1 = new JLabel("修改商品名");
		...
		JLabel lblNewLabel_1_1 = new JLabel("修改商品价格");
		...
		JLabel lblNewLabel_1_1_1 = new JLabel("修改商品余量");
