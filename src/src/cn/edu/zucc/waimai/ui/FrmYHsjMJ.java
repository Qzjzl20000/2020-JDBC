...
public class FrmYHsjMJ extends JFrame{
	...
	private JMenu menu_2 = new JMenu("查看商家满减");
	...
	public FrmYHsjMJ() {
	    ...
	    this.dataTableSjJTable.addMouseListener(new MouseAdapter (){
			...
			public void mouseClicked(MouseEvent e) {//鼠标点击动作，列出右边的列表
				int i=FrmYHsjMJ.this.dataTableSjJTable.getSelectedRow();
				if(i<0) {
					return;
				}
				FrmYHsjMJ.this.reloadSjFLTable(i);
			}
	    });
