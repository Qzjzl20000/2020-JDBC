...
public class FrmCMDmodifySJ extends JFrame {
	 ...
	 * Create the frame.
	 */
	public FrmCMDmodifySJ() {
		
	}
	public FrmCMDmodifySJ(BeanSj sj) {
		...
		JLabel lblNewLabel = new JLabel("您正在修改商家："+sj.getSj_name());
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==btnNewButton) {
					String sjname=new String(textField_1.getText());
					String xinji=new String(textField_2.getText());
					try {
						WaiMaiUtil.CMDManager.modifySj(sj,sjname,xinji);
						setVisible(false);
		...
		JLabel lblNewLabel_1 = new JLabel("修改商家名");
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNewLabel_1.setBounds(39, 68, 77, 21);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_1_1 = new JLabel("重评星级");
		lblNewLabel_1_1.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNewLabel_1_1.setBounds(39, 113, 77, 21);
		contentPane.add(lblNewLabel_1_1);
		
		textField_2 = new JTextField();
		textField_2.setBounds(128, 110, 130, 26);
