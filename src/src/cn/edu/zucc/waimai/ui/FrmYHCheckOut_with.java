...
public class FrmYHCheckOut_with extends JFrame {
	...
	public FrmYHCheckOut_with(BeanUserYHQ yhq) {
		...
		try {
			...
			money=WaiMaiUtil.userManager.BUY_money(BeanUser.currentLoginUser);
		} catch (BaseException e2) {
			// TODO Auto-generated catch block
			e2.printStackTrace();
		}
		try {
			count=WaiMaiUtil.userManager.BUY_count(BeanUser.currentLoginUser);
		} catch (BaseException e2) {
			// TODO Auto-generated catch block
			e2.printStackTrace();
		}
		...
		lblNewLabel.setBounds(25, 19, 270, 45);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("累计共"+count+"件,折扣共"+yhq.getYouhui_money()+"元");
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setBounds(25, 61, 270, 45);
