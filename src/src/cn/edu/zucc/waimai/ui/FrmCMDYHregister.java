...
public class FrmCMDYHregister extends JFrame {
...
//				}
	...
	public FrmCMDYHregister() {
		...
		JButton Button_2 = new JButton("新增用户");
		Button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(e.getSource()==Button_2) {
					...
					try {
						BeanUser user=WaiMaiUtil.CMDManager.reg(username,usersex,pwd1,pwd2,userphonenum,
								usere_mail,usercity);
						setVisible(false);
						JOptionPane.showMessageDialog(null, "新增成功", "系统提示",JOptionPane.INFORMATION_MESSAGE);
