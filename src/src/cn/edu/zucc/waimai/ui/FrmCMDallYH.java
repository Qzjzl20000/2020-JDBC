...
public class FrmCMDallYH extends JFrame{
	...
	private JMenuItem mntmNewMenuItem_2_1_1 = new JMenuItem("删除用户");
	private JMenuItem mntmNewMenuItem_2_1_1_1 = new JMenuItem("修改用户");
	private JMenu menu_3 = new JMenu("管理用户地址");
	private JMenuItem mntmNewMenuItem_3_1 = new JMenuItem("新建用户地址");
	private JMenuItem mntmNewMenuItem_3_1_1 = new JMenuItem("删除用户地址");
	private JMenuItem mntmNewMenuItem_3_1_1_1 = new JMenuItem("修改用户地址");
